<template>
    <jet-action-section>
        ...
        <template #description>
            Управляйте и выходите из активных сессий браузеров и других устройств.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                При необходимости вы можете выйти из всех других сеансов браузера на всех своих устройствах. Некоторые из ваших недавних сеансов перечислены ниже; однако этот список может быть не исчерпывающим. Если вы считаете, что ваша учетная запись была скомпрометирована, вам также следует обновить пароль.
            </div>
                ...
                <div class="flex items-center" v-for="(session, i) in sessions" :key="i">
                    ...
                    <div class="ml-3">
                        <div class="text-sm text-gray-600">
                            {{ session.agent.platform ? session.agent.platform : 'Unknown' }} - {{ session.agent.browser ? session.agent.browser : 'Неизвестно' }}
                        </div>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Пожалуйста, введите свой пароль, чтобы подтвердить, что вы хотите выйти из других сеансов на всех ваших устройствах.
